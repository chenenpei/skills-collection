...
**商业模式／业务原型**描述利润如何产生和维持；收费公路型、周期资产、金融杠杆资产等只能作为有证据的描述，允许不归类。**投资论点／投资分类**描述回报来自持续经营、成长投入、资产折价或修复等机制，见 `references/company.md` 的投资论点参考。二者均不替代当前价格与行动判断，也不是统一晋级阶梯。单一股票的通用定性流程见 [`references/equity.md`](references/equity.md)；银行、保险等金融企业再读 [`references/financial.md`](references/financial.md)。

## 股票定性研究的三问

对所有单一股票都把以下问题分开记录：

1. **价值问题**：在经营、资本和风险要求回报假设下，现价是否有风险补偿？
2. **预期差问题**：市场隐含的长期结果是否比公开证据支持的结果更差？
3. **路径问题**：如果存在预期差，什么可见事件会在持有期限内让市场重估？

“低估值”“没有立即恶化”和“管理层有规划”都只是线索，不能单独回答后三个问题。价值判断正确也可能长期不修复；没有催化剂时，不把中期估值修复写成确定事件。
...
**市场隐含命题**是从价格和资本结构反推的可能长期结果，不等于市场共识；**普通股传导**是把经营改善扣除风险、资本、少数股东、债务和必要留存后，连接到每股利润、现金或权益；**催化剂**是会使外部投资者更新长期假设的可观察事件，不是“下一季没变坏”本身。财报发布日期、例行审核日和价格触发属于信息节点，除非能改变外部预期，不自动算催化剂。
