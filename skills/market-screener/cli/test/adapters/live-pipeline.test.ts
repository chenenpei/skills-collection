...
import { enrichLiveUniverse } from "../../src/adapters/live-pipeline.js";
...
vi.mock("../../src/adapters/us/enrich.js", () => ({
...
describe("live adapter enrichRecords", () => {
  it("exposes enrichRecords on live adapter", async () => {
    const { createLiveAdapter } = await import("../../src/adapters/registry.js");
